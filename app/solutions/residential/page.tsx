    ...
    <div className={`min-h-screen bg-brand-bg ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden bg-brand-dark">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center text-white">
          <motion.span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="inline-block py-1 px-4 rounded-full bg-brand-red/20 border border-brand-red/50 text-brand-red text-sm font-semibold mb-6">
            {t.hero.subtitle}
          </motion.span>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-brand-red text-white rounded-full font-bold text-lg hover:bg-brand-red-dark transition-all shadow-lg">
              {t.hero.cta}
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="group relative overflow-hidden rounded-3xl bg-brand-dark aspect-[4/3] text-white">
            ...
            <div className="group relative overflow-hidden rounded-3xl bg-brand-silver aspect-[4/3] text-white">
              <div className="absolute inset-0 bg-black/60 z-10" />
              <div className="absolute inset-0 p-8 z-20 flex flex-col justify-end">
